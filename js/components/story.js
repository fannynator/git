...
const storySrc = {
    ...
    rus1: { id:'rus1', title:'📝 Дело о пропавшей запятой', subj:'russian', scenes: [
        ...
        { type:'choice', speaker:'Секретарша', emoji:'💼', text:'"Казнить нельзя помиловать".', question:'Где запятая?', options:['Казнить, нельзя','Казнить нельзя,','Казнить нельзя помиловать,','Не нужна'], correct:1, explanation:'После «нельзя»! ☠️→😇', trapId:'rcom' },
        { type:'dialogue', speaker:'Кот', emoji:'🐱', text:'Язык спасён! 🎉📚' }
    ]},
    rus2: { id:'rus2', title:'📝 Дело о двойных согласных', subj:'russian', scenes: [
        { type:'dialogue', speaker:'Кот', emoji:'🐱', text:'Мур! В библиотеке пропали буквы Н!' },
        ...
        { type:'choice', speaker:'Писатель', emoji:'✍️', text:'"Ветре...ый день".', question:'Н или НН?', options:['Н','НН'], correct:0, explanation:'ВетреНый — одна Н 🌬️', trapId:'rnn3' },
        { type:'input', speaker:'Поэт', emoji:'🎭', text:'"Пусты...ый пляж". Впиши: н или нн', question:'Сколько Н?', answer:'нн', explanation:'ПустыННый — стык корня и суффикса 🏖️', trapId:'rnn4' },
